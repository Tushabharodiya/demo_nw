<div class="container">
	<div class="bg0 flex-wr-sb-c p-tb-8">
        ...
        <?php $sessionBlogs = $this->session->userdata('session_blogs'); ?>
        <form action="" method="post" class="form-validate is-alter" enctype="multipart/form-data">
    		<div class="pos-relative size-a-2 bo-1-rad-22 of-hidden bocl11 m-tb-6">
    			<input class="f1-s-1 cl6 plh9 s-full p-l-25 p-r-45" type="text" name="search_blogs" value="<?php if(!empty($sessionBlogs)){ echo $sessionBlogs; } ?>" placeholder="Search" autocomplete="off">
...
<div class="container p-t-4 p-b-40">
	<h2 class="f1-l-1 cl2">
		<?php echo $subCategoryData['sub_category_name']; ?>
	</h2>
</div>
